import{g as w,a as C,r as S,u as $,j as k,s as b,c as x,d as R,m as A,w as M,aV as h,aW as f,aX as B,aY as F,aS as d,aZ as U,a_ as L}from"./index-DxMc1iCl.js";function T(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function j(t){return parseFloat(t)}function I(t){return w("MuiSkeleton",t)}C("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const q=t=>{const{classes:e,variant:a,animation:s,hasChildren:r,width:i,height:o}=t;return R({root:["root",a,s,r&&"withChildren",r&&!i&&"fitContent",r&&!o&&"heightAuto"]},I,e)},n=f`
  0% {
    opacity: 1;
  }
